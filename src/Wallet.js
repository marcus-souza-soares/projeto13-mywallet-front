...
export default function Wallet() {
    ...
    useEffect(() => {
        ...
        const promise = axios.get("https://marcus-mywallet.herokuapp.com/wallet", permission);
        promise.then(res => {
    ...
    const logout = () => {
        ...
        const promise = axios.delete('https://marcus-mywallet.herokuapp.com/logout', permission)
        promise.then(res => {
            alert(res.data);
            navigate("/");
        })
